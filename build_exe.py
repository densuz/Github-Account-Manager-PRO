...
def create_installer_packages():
    ...
    # Note: Installer and portable launcher packages have been removed from this project
    # Only the main executable and release files are now created
    
    print("✅ Distribution packages created (installer and portable launcher removed)")
...
def main():
    ...
    print("📄 Main executable: GitAccountManagerPro.exe")
